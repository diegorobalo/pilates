...
final class Plugin {
	...
	private function add_hooks() {
		...
		add_filter( 'elementor/editor/localize_settings', [ $this, 'add_jupiterx_version_to_elementor_editor' ] );
	 ...
	 * @return array
	 */
	public function add_jupiterx_version_to_elementor_editor( $settings ) {
		$version  = wp_get_theme()->get( 'Version' );
