	...
	public function register_section_checkbox() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-field-type-checkbox .raven-field-subgroup .raven-field-label,{{WRAPPER}} .raven-field-type-acceptance .raven-field-subgroup .raven-field-label',
				'scheme' => '3',
			]
		);
