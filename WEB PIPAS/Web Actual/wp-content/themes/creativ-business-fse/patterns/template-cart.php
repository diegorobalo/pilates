...
/**
 * Title: Template Cart
 * Slug: creativ-business-fse/template-cart
 * Categories: template
 * Inserter: false
 */
?>
...
<div class="wp-block-column" style="flex-basis:66.666%"><!-- wp:post-title {"textAlign":"center","level":1} /--></div>
<!-- /wp:column -->
...
<main class="wp-block-group" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)"><!-- wp:woocommerce/cart -->
...
<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'You may be interested in…', 'creativ-business-fse' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php esc_html_e( 'Your cart is currently empty!', 'creativ-business-fse' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><a href="<?php echo esc_url( home_url( '/shop' ) ); ?>"><?php esc_html_e( 'Browse store', 'creativ-business-fse' ); ?></a></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'New in store', 'creativ-business-fse' ); ?></h2>
<!-- /wp:heading -->
