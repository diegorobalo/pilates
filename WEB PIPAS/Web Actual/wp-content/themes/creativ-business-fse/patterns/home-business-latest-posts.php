...
/**
 * Title: Latest Posts
 * Slug: creativ-business-fse/home-latest-posts
 * Categories: theme
 *
...
<div class="wp-block-group" style="margin-bottom:0"><!-- wp:heading {"level":6,"style":{"typography":{"textTransform":"uppercase"},"color":{"text":"#4c0ee9"}},"fontSize":"x-small"} -->
<h6 class="wp-block-heading has-text-color has-x-small-font-size" style="color:#4c0ee9;text-transform:uppercase"><?php esc_html_e( 'Latest News', 'creativ-business-fse' ); ?></h6>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"letterSpacing":"-1px","lineHeight":"1.1"}},"fontSize":"xxx-large"} -->
<h3 class="wp-block-heading has-text-align-center has-xxx-large-font-size" style="letter-spacing:-1px;line-height:1.1"><?php esc_html_e( 'Our Blog Posts', 'creativ-business-fse' ); ?></h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<!-- wp:post-excerpt {"moreText":"Read More","excerptLength":15,"style":{"spacing":{"margin":{"top":"var:preset|spacing|x-small","bottom":"0"}},"elements":{"link":{"color":{"text":"#4c0ee9"}}}},"textColor":"contrast","fontSize":"small"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
<!-- /wp:post-template -->
...
<p class="has-text-align-center" style="font-style:normal;font-weight:300"><?php esc_html_e( 'No results', 'creativ-business-fse' ); ?></p>
<!-- /wp:paragraph -->
