 ...
 * Slug: creativ-business-fse/template-checkout
 * Categories: template
 * Inserter: false
 */
?>
...
<main class="wp-block-group" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)"><!-- wp:woocommerce/checkout {"align":"","className":"wc-block-checkout"} -->
