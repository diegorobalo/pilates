 ...
 * Slug: creativ-business-fse/template-search
 * Categories: template
 * Inserter: false
 */
?>
...
<p class="has-text-align-center has-large-font-size"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Try another search?', 'creativ-business-fse' ); ?></p>
<!-- /wp:paragraph -->
