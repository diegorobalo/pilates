 ...
 * Slug: creativ-business-fse/template-single
 * Categories: template
 * Inserter: false
 */
?>
...
<div class="wp-block-column" style="flex-basis:66.666%"><!-- wp:post-title {"textAlign":"center","level":1} /-->
...
<div class="wp-block-group"><!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|large"}}}} -->
<div class="wp-block-columns"><!-- wp:column {"width":"70%"} -->
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:post-featured-image {"style":{"border":{"radius":"30px"}}} /-->

<!-- wp:post-content /-->

<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:social-links {"iconColor":"background","iconColorValue":"#ffffff","openInNewTab":true,"showLabels":true,"size":"has-normal-icon-size","align":"left","style":{"spacing":{"blockGap":{"top":"15px","left":"20px"}}},"className":"is-style-pill-shape","layout":{"type":"flex","justifyContent":"center"}} -->
<ul class="wp-block-social-links alignleft has-normal-icon-size has-visible-labels has-icon-color is-style-pill-shape"><!-- wp:social-link {"url":"#","service":"facebook"} /-->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"creativ-business-fse"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
