 ...
 * Slug: creativ-business-fse/template-archive-product
 * Categories: template
 * Inserter: false
 */
?>
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar-shop","theme":"creativ-business-fse"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></main>
<!-- /wp:group -->