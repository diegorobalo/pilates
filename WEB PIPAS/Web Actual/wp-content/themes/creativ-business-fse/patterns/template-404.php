<?php
 /**
  * Title: Template 404
  * Slug: creativ-business-fse/template-404
  * Categories: template
  * Inserter: false
  */
?>
...
<p class="has-text-align-center"><?php esc_html_e( 'This page could not be found. Maybe try a search?', 'creativ-business-fse' ); ?></p>
<!-- /wp:paragraph -->
