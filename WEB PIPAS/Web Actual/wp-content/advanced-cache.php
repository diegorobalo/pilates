...
//DZ if ( false == defined( 'WPCACHEHOME' ) ) {
//DZ 	define( 'ADVANCEDCACHEPROBLEM', 1 );
//DZ } elseif ( ! include_once WPCACHEHOME . 'wp-cache-phase1.php' ) {
//DZ 	if ( ! @is_file( WPCACHEHOME . 'wp-cache-phase1.php' ) ) {
//DZ 		define( 'ADVANCEDCACHEPROBLEM', 1 );
//DZ 	}
//DZ }
